...
const Homepage: React.FC = () => {
  ...
  return (
        <div className="homepage">
          ...
          Estudo dos dados dos egressados do curso de Análise e Desenvolvimento de Sistemas. O projeto visa mapear o perfil e trajetória profissional dos ex-alunos, coletando informações diretamente dos egressos.
          </p>
          <p className="homepage-description">
